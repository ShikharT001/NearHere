...
const TAB_CONFIG = {
  Match: { label: 'Match', color: '#ff5a68' },
  Post: { label: 'Post', color: '#ff5a68' },
  Radar: { label: 'Radar', color: '#4C96F0' },
  Confessions: { label: 'Confessions', color: '#1B1919' },
  Profile: { label: 'Profile', color: '#ff5a68' },
};
...
export default function BottomNav() {
  ...
  const IconWrapper = ({ routeName, children }) => {
    ...
    const iconColor = isActive ? TAB_CONFIG[routeName].color : '#666';
    ...
    >
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Match')}>
        <IconWrapper routeName="Match">
          <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 48 48">
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="m18.044 13.446l2.437 11.338a2.335 2.335 0 0 0 2.774 1.792l2.956-.635l3.296 2.13l2.13-3.297l2.956-.635a2.335 2.335 0 0 0 1.792-2.774l-2.438-11.338a2.335 2.335 0 0 0-2.773-1.792l-11.338 2.438a2.335 2.335 0 0 0-1.792 2.773" strokeWidth={1}></path>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M31.595 15.408a2.534 2.534 0 0 0-3.01-1.945a2.53 2.53 0 0 0-1.862 1.657a2.53 2.53 0 0 0-2.379-.745a2.534 2.534 0 0 0-1.588 3.86c1.326 2.18 5.494 3.99 5.494 3.99s3.057-3.363 3.37-5.895a2.5 2.5 0 0 0-.025-.922M7.27 37.51l5.22-2.046c.958-.381 1.29-1.23 1.396-1.701c.214-.943-.04-1.972-.652-2.628a2.14 2.14 0 0 1 .116-3.024a2.13 2.13 0 0 1 3.023.116c1.226 1.324 1.88 3.142 1.847 4.976l8.084-3.17a2.144 2.144 0 0 1 2.776 1.208a2.15 2.15 0 0 1-1.208 2.776l-1.716.675" strokeWidth={1}></path>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M22.647 39.999a2.14 2.14 0 0 1-1.2-4.096l3.226-1.214a2.14 2.14 0 0 1 1.507 4.006l-3.226 1.214a2 2 0 0 1-.307.09m1.251 4.093a2.14 2.14 0 0 1-.935-4.16l1.937-.612a2.13 2.13 0 0 1 2.684 1.397a2.14 2.14 0 0 1-1.397 2.684l-1.937.611a2 2 0 0 1-.352.08" strokeWidth={1}></path>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M20.407 45.203c.937-.339 2.442-1.231 2.442-1.231" strokeWidth={1}></path>
            <circle cx={24} cy={24} r={21.5} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1}></circle>
          </svg>
        </IconWrapper>
      </TouchableOpacity>
        ...
        <IconWrapper routeName='Radar'>
          <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 24 24">
            <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}>
              <path d="M19.07 4.93A10 10 0 0 0 6.99 3.34M4 6h.01M2.29 9.62a10 10 0 1 0 19.02-1.27"></path>
              <path d="M16.24 7.76a6 6 0 1 0-8.01 8.91M12 18h.01m5.98-6.34a6 6 0 0 1-2.22 5.01"></path>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
        <IconWrapper routeName='Profile'>
          <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 24 24">
            <path fill="currentColor" fillRule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0m0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5z" clipRule="evenodd"></path>
          </svg>
        </IconWrapper>
      </TouchableOpacity>
    </View>
